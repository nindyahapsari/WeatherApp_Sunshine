...
import static com.nindyahapsari.android.sunshine.data.TestUtilities.BULK_INSERT_RECORDS_TO_INSERT;
import static com.nindyahapsari.android.sunshine.data.TestUtilities.createBulkInsertTestWeatherValues;
...
public class TestWeatherProvider {
    ...
    public void testBasicWeatherQuery() {
        ...
        /* Done with the database, close it now. */
        database.close();

        /* Perform our ContentProvider query. */
    ...
    public void testBulkInsert() {
        ...
        */
        ...
        /*
         * Expect that the number of test content values that we specify in our TestUtility
        ...
        /*
         * Perform our ContentProvider query. Expecting the cursor that is returned will contain
         * the exact same data that is in testWeatherValues and will validate that in the next
         * step.
         */
