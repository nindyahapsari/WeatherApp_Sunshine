...
import static com.nindyahapsari.android.sunshine.data.TestUtilities.getConstantNameByStringValue;
import static com.nindyahapsari.android.sunshine.data.TestUtilities.getStaticIntegerField;
import static com.nindyahapsari.android.sunshine.data.TestUtilities.getStaticStringField;
import static com.nindyahapsari.android.sunshine.data.TestUtilities.studentReadableClassNotFound;
import static com.nindyahapsari.android.sunshine.data.TestUtilities.studentReadableNoSuchField;
...
public class TestSunshineDatabase {
    ...
    public void testNullColumnConstraints() {
        ...
        /* need a cursor from a weather table query to access the column names */
        ...
        for (String columnName : weatherTableColumnNames) {
            ...
            /* don't need to verify the _ID column value is not null, the system does */
